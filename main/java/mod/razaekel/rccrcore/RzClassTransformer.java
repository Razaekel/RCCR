...
public abstract class RzClassTransformer
{
	...
	{
		return RzDevRemapper.getSrgName(FMLDeobfuscatingRemapper.INSTANCE.mapMethodName(node.owner, node.name, node.desc));
	}
	
	public static String getSrgName(String className, MethodNode node)
	{
		return RzDevRemapper.getSrgName(FMLDeobfuscatingRemapper.INSTANCE.mapMethodName(className, node.name, node.desc));
	}
	
	public static String getSrgName(FieldInsnNode node)
	{
		return RzDevRemapper.getSrgName(FMLDeobfuscatingRemapper.INSTANCE.mapFieldName(node.owner, node.name, node.desc));
	}
